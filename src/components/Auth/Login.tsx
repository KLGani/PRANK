    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">EduPredict</h1>
          <p className="text-sm md:text-base text-gray-600">AI-Powered Student Performance Predictor</p>
        </div>
